...
import 'mocha';
import {BasicSemanticVersion, BasicSemanticVersionFactory, SemanticVersionVendor} from './index';
...
describe('class: BasicSemanticVersionFactory', () => {
    it('method: create()', () => {
        ...
        expect(factory.create().constructor.name).is.equal('BasicSemanticVersion');
    });
});
...
describe('class: SemanticVersionVendor', () => {
    it('method: buyBasicSemanticVersion()', () => {
        ...
        expect(vendor.buyBasicSemanticVersion().constructor.name).is.equal('BasicSemanticVersion');
    });
});
